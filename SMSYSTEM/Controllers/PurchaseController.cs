    ...
    public class PurchaseController : BaseController
    {
        ...
        public ActionResult AddNewPurchase(int? id)
        {
            if (Session["LOGGEDIN"] != null)
            {
                ...
                objPurchaseVM_Property.WareHouseList = Helper.ConvertDataTable<WareHouse_Property>(ViewWareHouses());
                objPurchaseVM_Property.ProductList = Helper.ConvertDataTable<Product_Property>(objProductbll.ViewAll());
                objPurchaseVM_Property.purchaseDate = DateTime.Now.ToString("yyyy-MM-dd");
        ...
        public JsonResult AddUpdate(PurchaseVM_Property objpurchase)
        {
            try
            {
                ...
                objPurchaseProperty.purchaseDate = DateTime.Parse(objpurchase.purchaseDate);
                ...
                objPurchaseProperty.WarerHouseID = objpurchase.WarerHouseID;
                if (objpurchase.description == null)
                {
                    objPurchaseProperty.description = "";
                }
                else
                {
                    objPurchaseProperty.description = objpurchase.description;
                ...
                GenerateReport(objPurchaseProperty.idx, 4,"PO_Report");
