...
{
    public class Vendors_DAL : DBInteractionBase
    {
        private Vendors_Property objVendors;
        //private ErrorTracer objErrorTrace;

        public Vendors_DAL(Vendors_Property obj_Vendors)
        {
        ...
        public override DataTable SelectAll()
        {
            ...
            cmdToExecute.CommandText = @"select v.idx, concat(us.firstName,'',us.lastName) as userName,vt.vendorType,vc.vendorCategory,v.* from vendors v 
...
where v.visible=1";
        ...
        public  DataTable SelectAllByType(int id)
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"select * from vendors where vendorTypeIdx=@idx and visible=1";
            //cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("Vendors");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, false, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                cmdToExecute.Parameters.Add(new SqlParameter("@idx", SqlDbType.Int, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, id));
                //cmdToExecute.Parameters.Add(new SqlParameter("@idx", SqlDbType.Int, 5000, ParameterDirection.Output, false, 10, 0, "", id));
        ...
        public override bool Insert()
        {
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@emailAddress", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objVendors.emailAddress));
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@strn", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objVendors.strn));
                ...
                //cmdToExecute.Parameters.Add(new SqlParameter("@price", SqlDbType.Decimal, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objVendors.price));
        ...
        public DataTable SelectByCatId(int? id)
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"select * from vendors where vendorCatIdx=@idx";
            //cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("Vendors");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
