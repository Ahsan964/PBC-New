...
{
    public class Customers_DAL : DBInteractionBase
    {
        private Customers_Property objVendors;
...
where v.visible=1";
        ...
        public DataTable ddlCustomersType()
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"select idx,customerType from customerType where visible=1";
            //cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("Customers");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "[dbo].[sp_insert_Customers]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@customerTypeIdx", SqlDbType.Int, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objVendors.customerTypeIdx));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "[dbo].[sp_update_Customers]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"update Customers SET visible=0 where idx=@idx";
            //cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"select Concat(us.firstName,'',us.lastName) as userName,pc.* from Customers pc
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@idx", SqlDbType.Int, 100, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objVendors.idx));
