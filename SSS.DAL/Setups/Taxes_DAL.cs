...
namespace SSS.DAL.Setups
{
    public class Taxes_DAL : DBInteractionBase
    {
        ...
        public override bool Insert()
        {
            ...
            //(
            //taxName,taxPercent,createdByUserIdx,IsClaimble,taxAuthorityIdx
            //)
            //values
            //(
            //@taxName,@taxPercent,@createdByUserIdx,@IsClaimble,@taxAuthorityIdx
            //)";
            cmdToExecute.CommandText = "dbo.[sp_TaxInsert]";
            ...
            {
                // Added By Ahsan
               // cmdToExecute.Parameters.Add(new SqlParameter("@coaIdx", SqlDbType.Int, 50, ParameterDirection.out, true, 0, 0, "", DataRowVersion.Proposed, objTaxesProperty.IsClaimble));
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@IsClaimble", SqlDbType.Int, 50, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objTaxesProperty.IsClaimble));
                cmdToExecute.Parameters.Add(new SqlParameter("@taxAuthorityIdx", SqlDbType.NVarChar, 50, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objTaxesProperty.taxAuthorityIdx));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            //cmdToExecute.CommandText = @"update Taxes set taxName=@taxName,IsClaimble=@IsClaimble,taxAuthorityIdx=@taxAuthorityIdx,taxPercent=@taxPercent,lastModifiedByUserIdx=@lastModifiedByUserIdx,
            //  lastModificationDate=@lastModificationDate where idx=@idx";
            //cmdToExecute.CommandType = CommandType.StoredProcedure;
            cmdToExecute.CommandText = "dbo.[sp_TaxUpdate]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            // Use base class' connection object
            cmdToExecute.Connection = _mainConnection;
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@taxName", SqlDbType.NVarChar, 100, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objTaxesProperty.taxName));
                cmdToExecute.Parameters.Add(new SqlParameter("@IsClaimble", SqlDbType.Int, 100, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objTaxesProperty.IsClaimble));
                cmdToExecute.Parameters.Add(new SqlParameter("@taxAuthorityIdx", SqlDbType.Int, 100, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objTaxesProperty.taxAuthorityIdx));
                cmdToExecute.Parameters.Add(new SqlParameter("@taxPercent", SqlDbType.Decimal, 100, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objTaxesProperty.taxPercent));
        ...
        public DataTable SelectBytaxAuthorityId()
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"select taxAuthorityIdx,taxAuthority from taxAuthority  ";
            /*mdToExecute.CommandText = CommandType.StoredProcedure;*/
            DataTable toReturn = new DataTable("taxAuthority");
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@idx", SqlDbType.Int, 100, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, objTaxesProperty.taxAuthorityIdx));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "sp_GetAllInputTaxes";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "sp_GetAllOutputTaxes";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
