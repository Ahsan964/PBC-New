...
{
    public class WareHouse_DAL:DBInteractionBase
    {
        ...
        public override DataTable SelectAll()
        {
            ...
            cmdToExecute.CommandText = "dbo.[sp_GetAllWareHouse]";
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"update WareHouse SET IsActive=0 where Idx=@ID";
            //cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@ID", SqlDbType.Int, 100, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objWarehouse.Idx));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_Insert_Update_WareHouse]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@BranchIdx", SqlDbType.VarChar, 20, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objWarehouse.BranchIdx));
                cmdToExecute.Parameters.Add(new SqlParameter("@WareHouseName", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objWarehouse.WareHouseName));
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@lastModifiedByUserIdx", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objWarehouse.lastModifiedByUserIdx));

                if (objWarehouse.Idx > 0)
                {
                    cmdToExecute.Parameters.Add(new SqlParameter("@LastModificationDate", SqlDbType.DateTime, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objWarehouse.LastModificationDate));
                }
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@Isvisible", SqlDbType.Bit, 1, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objWarehouse.IsActive));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_GetWareHouseBybranchId]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("WH_LOCATIONS");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
