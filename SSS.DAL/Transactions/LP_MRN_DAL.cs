...
{
    public class LP_MRN_DAL : DBInteractionBase
    {
        ...
        public LP_MRN_DAL(LP_MRN_Master_Property objMRMasterProperty)
        {
            _objMRMasterProperty = objMRMasterProperty;
        }
        public LP_MRN_DAL(LP_MRN_Detail_Property objMRDetailProperty)
        {
        ...
        public override bool Insert()
        {
            ...
            {
                cmdToExecute.CommandText = "dbo.[sp_MRNUpdate]";
            }
            else
            {
                cmdToExecute.CommandText = "dbo.[sp_MRNInsert]";
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@mrNumber", SqlDbType.NVarChar, 50, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, _objMRMasterProperty.mrNumber));
              
                cmdToExecute.Parameters.Add(new SqlParameter("@mrnDate", SqlDbType.DateTime, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, _objMRMasterProperty.mrnDate));

                cmdToExecute.Parameters.Add(new SqlParameter("@description", SqlDbType.NVarChar, 80, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _objMRMasterProperty.description));
            
               cmdToExecute.Parameters.Add(new SqlParameter("@WarerHouseID", SqlDbType.Int, 50, ParameterDirection.Input, true, 18, 1, "", DataRowVersion.Proposed, _objMRMasterProperty.WarerHouseID));

                cmdToExecute.Parameters.Add(new SqlParameter("@createdbyuser", SqlDbType.Int, 4, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _objMRMasterProperty.createdByUserIdx));
                cmdToExecute.Parameters.Add(new SqlParameter("@creationdate", SqlDbType.DateTime, 50, ParameterDirection.Input, true, 18, 1, "", DataRowVersion.Proposed, _objMRMasterProperty.creationDate));

                cmdToExecute.Parameters.Add(new SqlParameter("@visible", SqlDbType.Int, 4, ParameterDirection.Input, true, 18, 1, "", DataRowVersion.Proposed, _objMRMasterProperty.visible));
                cmdToExecute.Parameters.Add(new SqlParameter("@status", SqlDbType.Int, 4, ParameterDirection.Input, true, 18, 1, "", DataRowVersion.Proposed, _objMRMasterProperty.status));
                ...
                if (_objMRMasterProperty.DetailData != null)
                {
                    foreach (DataRow row in _objMRMasterProperty.DetailData.Rows)
                    {
                        ...
                        _objMRMasterProperty.idx=Convert.ToInt32(cmdToExecute.Parameters["@ID"].Value.ToString());
                        row["mrnIdx"] = cmdToExecute.Parameters["@ID"].Value.ToString();
                    ...
                    _objMRMasterProperty.DetailData.TableName = "mrnDetails";
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"update MRN SET visible=0 where idx=@ID";
            //cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@ID", SqlDbType.Int, 100, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _objMRMasterProperty.idx));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_selectAllMRN]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "select idx,concat('MR-',idx) as mrNumber from MRN where visible=1 and status=0";
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_SelctMRByid]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@poid", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, _objMRMasterProperty.idx));
