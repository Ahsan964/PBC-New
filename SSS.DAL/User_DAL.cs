...
namespace SSS.DAL
{
    public class User_DAL : DBInteractionBase
    {
        ...
        //private ErrorTracer objErrorTrace;GetUserPagsAccess
        public User_DAL()
        {
        ...
        public override bool Insert()
        {
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@departmentIdx", SqlDbType.Int, 100, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objUserProperty.departmentIdx));
        ...
        public DataTable SelectByDepartmentId()
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"select idx,Department from Departments where visible=1  ";
            /*mdToExecute.CommandText = CommandType.StoredProcedure;*/
            DataTable toReturn = new DataTable("Department");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                //cmdToExecute.Parameters.Add(new SqlParameter("@idx", SqlDbType.Int, 100, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, objUserProperty.departmentIdx));
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'sp_Department_SelectAll' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("Department::SelectAll::Error occured.", ex);
            }
            finally
            {
                if (_mainConnectionIsCreatedLocal)
